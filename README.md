# Employee ID Generator with QR Verification

Automated employee ID card synthesis system built with Django utilizing qrcode generation, printable ID templates, and cryptographic verification badges.
...
- **Technologies**: Django 4+, qrcode, Pillow, HTML5, CSS3, Python 3.11
- **Lead Developer**: MASA
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/XREFS0/masa-django-employee-qr.git
   cd masa-django-employee-qr
   ```
